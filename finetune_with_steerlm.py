...
#model_name = f"llama32_1b_sft_{attributes_names}_attribute" #"meta-llama/Llama-3.2-1B-Instruct"
model_name = f"llama32_1b_steerlm_{attributes_names}_attribute"
new_model_name = f"llama32_1b_after_clustering_steerlm_{attributes_names}_attribute"
